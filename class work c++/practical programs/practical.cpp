...
Declare variable out that one var should be static
Inline static fun define
 default constructor
copy constructor
destructor
craete()
...
int main()
{
 ...
 do
 {
	 ...
	 case 1: // create database
	 {
		 for(int i=0;i<n;i++)
		 {
		       sobj[i].create(pobj[i]); //refrence to per_info class
		       sobj[i].inccnt();     //static function
